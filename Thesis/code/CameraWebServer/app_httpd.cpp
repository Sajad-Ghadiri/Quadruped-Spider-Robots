...
const char *servername ="http://172.21.232.174" ;
...
//                Serial.printf("Found URL query parameter => color=%s\n", param);
                // use param here
                Serial.write(param);
//                Serial.print(255);
//                Serial.write(255);
    ...
    const char resp[] = "Sajjad Ghadiri";
